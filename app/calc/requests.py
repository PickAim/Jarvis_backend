...
@calc_router.post(ACCESS_TOKEN_USAGE_URL_PART + '/jorm_margin/')
...
@calc_router.get(ACCESS_TOKEN_USAGE_URL_PART + '/jorm_data/')
...
@calc_router.get(ACCESS_TOKEN_USAGE_URL_PART + '/save_request/')
